...
class TValidator {
  ...
  static String? validateUsername(String? username) {
    ...
    // Define regular expression pattern for the username
  ...
  static String? validatePhoneNumber(String? value) {
    ...
    // Regular expression for phone number validation (assuming a 13-digit Nigerian phone number format, starting with "234")
    final phoneRegExp = RegExp(r'^(?:\+234|234|0)\d{10}$');

    if (!phoneRegExp.hasMatch(value)) {
      return "Invalid phone number format (Nigerian Phone Number format required)";
    }
