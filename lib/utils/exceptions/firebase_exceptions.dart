  ...
  String get message {
    switch (code) {
      ...
      case "operation-not-allowed":
        return "Operation not allowed. Contact support for assistance";
      ...
      case "app-not-authorised":
        return "The app is not authorised to use Firebase Authentication with the provided API key";
      case "keychain-error":
        return "A keychain error occurred. Please check the keychain and try again";
      case "internal-error":
        return "An internal authentication error occurred. Please try again later";
      case "invalid-app-credential":
        return "This app credential is invalid. Please provide a valid app credential";
      case "user-mismatch":
        return "The supplied credentials do not apply to the previously signed-in user";
      ...
      case "uid-already-exists":
        return "The provided suer ID is already in use by another user";
