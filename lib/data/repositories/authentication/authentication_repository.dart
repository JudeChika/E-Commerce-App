...
import '../../../utils/exceptions/format-exceptions.dart';
  ...
  void screenRedirect() async {
    ...
    if (user != null) {
      ...
      if (user.emailVerified) {
        // If the user's email is verified, navigate to the main Navigational Menu
...
/* -------------------------- Email & Password sign in ------------------------------- */
  ...
  Future<void> reAuthenticateWithEmailAndPassword(String email, password) async {
    try {
      // Create a credential
  ...
  /* End Federated Identity & sign in */
