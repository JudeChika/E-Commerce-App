      ...
      children: [
        ...
        Row(
          children: [
            ...
            /// Price
            Text("\$2,400", style: Theme.of(context).textTheme.titleSmall!.apply(decoration: TextDecoration.lineThrough)),
            const SizedBox(width: TSizes.spaceBtwItems),
            const TProductPriceText(price: "600", isLarge: true),
          ],
        ),
        const SizedBox(height: TSizes.spaceBtwItems),

        /// Title
        const TProductTitleText(title: "Black iPhone 14 Pro"),
        const SizedBox(height: TSizes.spaceBtwItems),
