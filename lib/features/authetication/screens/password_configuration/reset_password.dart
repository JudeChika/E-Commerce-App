import 'package:e_commerce_application/features/authetication/controllers/forget_password/forget_password_controller.dart';
...
class ResetPasswordScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        automaticallyImplyLeading: false, // Removes the back arrow from the screen
